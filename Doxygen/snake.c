...
#define COTE_BORDURE '#'    /**< Caractère utilisé pour afficher les bordures et pavés. */
#define POMME '6'           /**< Caractère qui représente une pomme. */
#define ACCELERATION 0.9    /**< Valeur pour diminuer l'acceleration. */
...
const int VITESSE_JEU = 150000;             /**< Temporisation entre les déplacements en microsecondes. */
