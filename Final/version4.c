/**
 * @file version4.c
 * @brief Jeu Snake SAÉ1.01 - Version 4 avec accélération et croissance du serpent aprés avoir une pomme
 * @details Implémentation du jeu Snake avec accélération progressive , croissance et des pommes
 */
