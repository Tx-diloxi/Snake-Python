/**
 * @file version5.c
 * @brief Jeu Snake SAÉ1.01 - Version 5 avec accélération et croissance du serpent
 * @details Implémentation du jeu Snake avec accélération progressive et croissance
 */
...
int main()
{
    ...
    while (condition_arret == TRUE) {
        ...
        if (pomme_mangee) {
            ...
            vitesse_actuelle = vitesse_actuelle * 0.9;
            taille_serpent++;
